...
import imgCannabis from '../assets/CannabisPhoto.png'
    ...
    <div className=" mt-28 mb-36 max-w-[1200px] mx-auto">
      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        <div className="flex flex-col items-center">
          <a href="/pageprojcannabis" title="Project 1">
            <img src={imgCannabis} alt="Project 1" className="h-64 w-[500px] rounded-lg shadow-md hover:shadow-lg transition duration-300" />
          </a>
        ...
        <div className="flex flex-col items-center">
          <a href="/pageprojblog" title="Project 2">
            <img src={imgBlog} alt="Project 2" className="h-64 w-[500px] rounded-lg shadow-md hover:shadow-lg transition duration-300" />
          </a>
